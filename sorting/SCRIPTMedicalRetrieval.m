...
labelsPath     = 'C:\Users\loand\Documents\GitHub\Tesisti\SeedClasification\sorting\Labels';
featsPath      = 'C:\Users\loand\Documents\GitHub\Tesisti\SeedClasification\sorting\Features';
retrievePath   = 'C:\Users\loand\Documents\GitHub\Tesisti\SeedClasification\sorting\Retrieval';
perfPath      = 'C:\Users\loand\Documents\GitHub\Tesisti\SeedClasification\sorting\Performance';  
...
if computePerformances == 1
    ...
    for dt = 1:numel(datasets)
        ...
        numReturnedImages = 1:length(labels)-1; 
        for dsc = 1:numel(descriptors)
            for gl = 1:numel(graylevel)
                for pp = 1:numel(prepro)
